 ...
 * @author luisp
 */
public class TelaDetalheFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroFuncionario
     */
    public TelaDetalheFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jListCargo = new javax.swing.JList<String>();
        ...
        jListCargo.setModel(new javax.swing.AbstractListModel() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDetalheFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDetalheFuncionario().setVisible(true);
            }
        });
    }
